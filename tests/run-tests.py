...
class TestEditFile(unittest.TestCase):
    ...
    def test_basic_without_line(self) -> None:
        ...
        expect_edit_file(file_path, None, {"EDITOR": editor},
                         (editor, file_path))
    ...
    def test_basic_with_line(self) -> None:
        ...
        file_path = "some_file.txt"
        line_number = 42
        expect_edit_file(file_path, line_number, {"EDITOR": editor},
    ...
    def test_arguments(self) -> None:
        ...
        expect_edit_file(file_path, line_number,
    ...
    def test_precedence(self) -> None:
        ...
        fake_environment: typing.Dict[str, str] = {}
        expect_edit_file(file_path, line_number, fake_environment,
